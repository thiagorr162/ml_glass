...
# PCA aplicado aos dados originais completos
print("Aplicando PCA aos dados originais (todos)...")
...
# Salvar
plt.savefig(save_path / "pca_dados_originais_2classes.png", dpi=300)
plt.show()
